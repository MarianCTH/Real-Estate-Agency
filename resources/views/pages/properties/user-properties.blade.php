                ...
                <div class="pro-wrapper">
                    ...
                    <div class="cod-pad single detail-wrapper mr-2 mt-0 d-flex justify-content-md-end align-items-center">
                        <div class="input-group border rounded input-group-lg w-auto mr-4">
                            <form action="{{ route('user.properties', ['user' => $user->id]) }}" method="GET" id="sortForm">
                                <div class="input-group border rounded input-group-lg w-auto mr-4">
                                    ...
                                    <select class="form-control border-0 bg-transparent shadow-none p-0 selectpicker sortby"
                                        ...
                                        <option value="normal" {{ $sortBy == 'normal' ? 'selected' : '' }}>Normal</option>
                                        <option value="1" {{ $sortBy == '1' ? 'selected' : '' }}>Cele mai vizualizate</option>
                                        <option value="2" {{ $sortBy == '2' ? 'selected' : '' }}>Preț (crescător)</option>
                                        <option value="3" {{ $sortBy == '3' ? 'selected' : '' }}>Preț (descrescător)</option>
                                    </select>
                                </div>
                            </form>
                        </div>
