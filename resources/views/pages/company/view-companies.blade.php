               ...
               <section class="headings-2 pt-0">
                    <div class="pro-wrapper">
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <form action="{{ route('agencies') }}" method="GET" class="mb-0">
                                        <div class="input-group border rounded input-group-lg w-auto">
                                            <input type="text" name="search" class="form-control border-0 bg-transparent" placeholder="Caută societăți..." value="{{ request('search') }}">
                        ...
                        <div class="cod-pad single detail-wrapper mr-2 mt-0 d-flex justify-content-md-end align-items-center grid">
                            <form action="{{ route('agencies') }}" method="GET" class="d-flex align-items-center">
