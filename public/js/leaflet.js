...
!(function (t, e) {
    ...
    var e = {
            ...
            removeEventParent: function (t) {
                return (
                    this._eventParents && delete this._eventParents[h(t)], this
                );
            },
                    ...
                    ve(this._element, "leaflet-zoom-anim") ||
                        (t.touches && 1 !== t.touches.length
                            ...
                            : Je._dragging ||
                              ...
                              ((Je._dragging = this)._preventOutline &&
                                  Me(this._element),
                              Le(),
                              re(),
                              this._moving ||
    ...
    function wi(t, e) {
        ...
        switch (r.type) {
            ...
            case "MultiLineString":
                return (
                    (n = Li(a, "LineString" === r.type ? 0 : 1, u)),
                    new vi(n, e)
                );
            case "Polygon":
            case "MultiPolygon":
                return (
                    (n = Li(a, "Polygon" === r.type ? 1 : 2, u)), new yi(n, e)
                );
