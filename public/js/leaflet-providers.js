(function (root, factory) {
	...
	L.TileLayer.Provider.providers = {
		...
		OpenFireMap: {
			...
			options: {
				maxZoom: 19,
				attribution: ' Map style: &copy; <a href="http://www.openfiremap.org">OpenFireMap</a> (<a href="https://creativecommons.org/licenses/by-sa/3.0/">CC-BY-SA</a>)'
			}
		},
		SafeCast: {
			...
			options: {
				maxZoom: 16,
				attribution: ' | Map style: &copy; <a href="https://blog.safecast.org/about/">SafeCast</a> (<a href="https://creativecommons.org/licenses/by-sa/3.0/">CC-BY-SA</a>)'
			}
		},
		Thunderforest: {
		...
		OpenMapSurfer: {
			...
			options: {
				maxZoom: 20,
				variant: 'roads',
				attribution: 'Imagery from <a href="http://giscience.uni-hd.de/">GIScience Research Group @ University o{attribution.OpenStreetMap}'
			},
			variants: {
				Roads: 'roads',
				AdminBounds: {
		...
		Hydda: {
			...
			options: {
				maxZoom: 18,
				variant: 'full',
				attribution: 'Tiles courtesy of <a href="http://openstreetmap.se/" target="_blank">OpenStreetMap Sweden</a> &mdash; {attribution.OpenStreetMap}'
			},
			variants: {
				Full: 'full',
				Base: 'base',
